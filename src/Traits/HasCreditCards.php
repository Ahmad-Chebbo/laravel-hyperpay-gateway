...
trait HasCreditCards
{
    ...
    {
        return $this->morphMany(\AhmadShebbo\LaravelHyperpay\Models\CreditCard::class, 'cardable');
    }
     ...
     */
    public function defaultCreditCard(): ?\AhmadShebbo\LaravelHyperpay\Models\CreditCard
    {
     ...
     */
    public function addCreditCard(array $cardData): \AhmadShebbo\LaravelHyperpay\Models\CreditCard
    {
     ...
     */
    public function saveCreditCardFromResponse(array $response, array $cardInfo = []): ?\AhmadShebbo\LaravelHyperpay\Models\CreditCard
    {
     ...
     */
    public function getCreditCardByRegistrationId(string $registrationId): ?\AhmadShebbo\LaravelHyperpay\Models\CreditCard
    {
